...
HD_PWD='C:/Users/mlech/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log advanced_logic_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source advanced_logic_module.tcl
