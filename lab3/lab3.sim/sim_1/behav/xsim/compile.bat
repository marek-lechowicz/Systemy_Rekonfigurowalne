...
REM
REM Generated by Vivado on Thu Mar 17 00:38:00 +0100 2022
...
echo "xvlog --incr --relax -prj tb_receivermodule_vlog.prj"
call xvlog  --incr --relax -prj tb_receivermodule_vlog.prj -log xvlog.log
