...
HD_PWD='D:/studia_zadania/SR/Systemy_Rekonfigurowalne/lab4/lab4.runs/c_addsub_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_7.tcl
