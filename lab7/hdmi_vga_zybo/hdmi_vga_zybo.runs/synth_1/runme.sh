...
HD_PWD='D:/studia_zadania/SR/hdmi_vga_zybo.xpr/hdmi_vga_zybo/hdmi_vga_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vp.tcl
