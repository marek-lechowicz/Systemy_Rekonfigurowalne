...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../hdmi_vga_zybo.gen/sources_1/bd/hdmi_vga/ipshared/62b6" \
       +incdir+"../../../../hdmi_vga_zybo.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" \
       +incdir+"../../../../hdmi_vga_zybo.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
       +incdir+"../../../../hdmi_vga_zybo.gen/sources_1/bd/hdmi_vga/ipshared/62b6"
}
