...
REM
REM Generated by Vivado on Sun Apr 10 21:56:39 +0200 2022
...
echo "xvlog --incr --relax -prj tb_main_lut_vlog.prj"
call xvlog  --incr --relax -prj tb_main_lut_vlog.prj -log xvlog.log
