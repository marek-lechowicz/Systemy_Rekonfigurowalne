...
HD_PWD='D:/studia_zadania/SR/Systemy_Rekonfigurowalne/lab5/simulation_models/simulation_models.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_lut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_lut.tcl
