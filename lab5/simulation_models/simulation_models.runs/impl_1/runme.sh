...
HD_PWD='D:/studia_zadania/SR/Systemy_Rekonfigurowalne/lab5/simulation_models/simulation_models.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_lut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_lut.tcl -notrace
